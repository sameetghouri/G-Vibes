    ...
    <div className="flex flex-col items-center mb-4 h-64 bg-[url(/banner.png)] bg-cover rounded-b">
      <nav className='w-full flex items-center justify-end py-3'>
        ...
        <ul className='flex items-center gap-3 pr-3'>
          ...
          <li onClick={login} className='border rounded px-1 border-white hover:border-blue-500 hover:text-blue-500 text-white font-bold cursor-pointer'>Login/Signup</li>
          <li onClick={logout} className='border rounded px-1 border-white hover:border-blue-500 hover:text-blue-500 text-white font-bold cursor-pointer'>Logout</li>
        </ul>
      </nav>
